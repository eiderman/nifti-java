...
/**
 * Support a signed 16 bit integer based volume array.<br>
 * See the documentation for IndexedVolumeArray for more data.
 * @author Eider Moore
 * @version 1.0
 */
class ShortIndexedVolumeArray
     ...
     */
    public ShortIndexedVolumeArray(int maxX, int maxY, int maxZ, int maxTime, int maxI5,
            Matrix4d index2space, short[] array) {
    ...
    public void setData(int index, double value) {
        short v = (short) Math.round(value);
        array[index] = v;
    }
