...
/**
 * Support a single precision floating point based volume array.<br>
 * See the documentation for VolumeArray for more data.
 * @author Eider Moore
 * @version 1.0
 */
class FloatIndexedVolumeArray
     ...
     */
    public FloatIndexedVolumeArray(int maxX, int maxY, int maxZ, int maxTime, int maxI5,
            Matrix4d index2space, float[] array) {
