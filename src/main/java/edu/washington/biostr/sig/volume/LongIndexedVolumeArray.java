...
/**
 * Support a signed 64 bit integer based volume array.<br>
 * See the documentation for IndexedVolumeArray for more info.
 * @author Eider Moore
 * @version 1.0
 */
class LongIndexedVolumeArray
     ...
     */
    public LongIndexedVolumeArray(int maxX, int maxY, int maxZ, int maxTime, int maxI5,
            Matrix4d index2space, long[] array) {
